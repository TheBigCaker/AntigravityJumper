...
class RelayClient:
    def __init__(
        ...
        self.ws_url = f"{self.relay_url}/ws/{machine_id}"
        self.secret = secret
    ...
    def on(self, event_type: str, handler: Callable):
        """Register a handler for a message type. handler(msg: dict)"""
    ...
    async def _sender(self, ws):
        while True:
            ...
            try:
                ...
                await self._send_queue.put(data)  # re-queue
                break

    async def connect(self):
        """Start the client — runs forever with auto-reconnect."""
        self._running = True
...
if __name__ == "__main__":
    ...
    # Also start a simple stdin sender
